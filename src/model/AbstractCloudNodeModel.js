...
draw2d.AbstractCloudNodeModel.EVENT_ANGLE_CHANGED = "angle changed";
draw2d.AbstractCloudNodeModel.EVENT_MINIMIZED_CHANGED = "minimized changed";
 ...
 *
 * @param {draw2d.ArcModel}
    **/
draw2d.AbstractCloudNodeModel.prototype.removeConnectionModel = function (/*:draw2d.ArcModel*/ connection) {
    if (!(connection instanceof draw2d.AbstractConnectionModel)) {
