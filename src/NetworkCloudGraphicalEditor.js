...
draw2d.NetworkCloudGraphicalEditor.prototype.setModel = function (/*:draw2d.AbstractObjectModel*/ model) {
    try {
        ...
        var part1 = new draw2d.PNPlacePalettePart(model);
        var part2 = new draw2d.PNMessagePalettePart(model);
        var part3 = new draw2d.TransitionPalettePart(model);
        var part4 = new draw2d.PNEventPalettePart(model);
        ...
        palette.addPalettePart(part4);
        part4.setPosition(20, 190);
