 ...
 * @constructor
 **/
draw2d.OutArcOutputPort = function () {
...
/** @private **/
draw2d.OutArcOutputPort.prototype = new draw2d.OutputPort();
/** @private **/
draw2d.OutArcOutputPort.prototype.type = "draw2d.OutArcOutputPort";
 ...
 * @type draw2d.Command
 **/
draw2d.OutArcOutputPort.prototype.createCommand = function (/*:draw2d.EditPolicy*/ request) {
    ...
    if (request.getPolicy() === draw2d.EditPolicy.CONNECT) {
        ...
        if (request.source instanceof draw2d.OutArcInputPort) {
            ...
            return new draw2d.CommandConnect(targetModel, sourceModel);
        }
        return null;
    }
