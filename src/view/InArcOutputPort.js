 ...
 * @constructor
 **/
draw2d.InArcOutputPort = function () {
...
/** @private **/
draw2d.InArcOutputPort.prototype = new draw2d.OutputPort();
/** @private **/
draw2d.InArcOutputPort.prototype.type = "draw2d.InArcOutputPort";
 ...
 * @type draw2d.Command
 **/
draw2d.InArcOutputPort.prototype.createCommand = function (/*:draw2d.EditPolicy*/ request) {
    ...
    if (request.getPolicy() == draw2d.EditPolicy.CONNECT) {
        ...
        if (request.source instanceof draw2d.InArcInputPort) {
