 ...
 * @constructor
 **/
draw2d.InArcInputPort = function () {
...
draw2d.InArcInputPort.prototype = new draw2d.InputPort();
/** @private **/
draw2d.InArcInputPort.prototype.type = "draw2d.InArcInputPort";
 ...
 * @type draw2d.Command
 **/
draw2d.InArcInputPort.prototype.createCommand = function (/*:draw2d.EditPolicy*/ request) {
    ...
    if (request.getPolicy() === draw2d.EditPolicy.CONNECT) {
        ...
        if (request.source instanceof draw2d.InArcOutputPort) {
